...
def add_cover_slide(prs, title, subtitle, image_path):
...
# 第1页：封面
add_cover_slide(prs, "柳州城市介绍", "桂中明珠·龙城柳州", f"{IMG_DIR}/liuzhou_1.jpg")

# 第2页：地理位置
add_image_content_slide(prs, 2, "地理位置",
    f"{IMG_DIR}/liuzhou_5.jpg",
    [
        "位于广西壮族自治区中部偏东北",
        "地处桂中盆地，珠江水系柳江上游",
        "总面积 18,677 平方公里",
...
# 第11页：结束页
add_ending_slide(prs, "谢谢观看", "柳州——一座让人流连忘返的城市 🚀", f"{IMG_DIR}/liuzhou_11.jpg")

# 保存
output_path = "/Users/blade/Desktop/柳州城市介绍_柳州真图版.pptx"
