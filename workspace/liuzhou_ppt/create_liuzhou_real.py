...
add_image_content_slide(prs, 8, "特色美食",
    f"{IMG_DIR}/temple.jpg",  # Could use food image but temple works for Chinese style
    [
        "螺蛳粉：柳州第一美食，酸辣鲜香",
        "牛腊巴：柳城特产，香脆可口",
        "云片糕：甜而不腻，入口即化",
...
# 保存
output_path = "/Users/blade/Desktop/柳州城市介绍_真图版.pptx"
