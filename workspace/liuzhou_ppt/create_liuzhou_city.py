...
def add_cover_slide(prs, title, subtitle):
    ...
    if os.path.exists(f"{IMG_DIR}/city1.jpg"):
        slide.shapes.add_picture(f"{IMG_DIR}/city1.jpg", 0, 0, width=prs.slide_width, height=prs.slide_height)
...
def add_ending_slide(prs, title, subtitle):
    ...
    if os.path.exists(f"{IMG_DIR}/city_night.jpg"):
        slide.shapes.add_picture(f"{IMG_DIR}/city_night.jpg", 0, 0, width=prs.slide_width, height=prs.slide_height)
...
# 保存
output_path = "/Users/blade/Desktop/柳州城市介绍_城市风景版.pptx"
